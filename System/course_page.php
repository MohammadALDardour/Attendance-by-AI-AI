...
// Get the current month from device 
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="navigation"> <!-- buttons to change the months -->
        ...
        <div class="edit-button">
            <button class="button" onclick="window.location.href='course_page_edit.php?course_id=<?php echo $course_id; ?>&section_number=<?php echo $section_number; ?>'">Edit</button>
        </div>
    </div>

    <!-- The Modal to zoom in the excuse pic-->
    ...
    <script>// control the change month buttons
        function changeMonth(offset) { 
            const currentMonth = new Date('<?php echo $month; ?>-01');
            currentMonth.setMonth(currentMonth.getMonth() + offset);
            const newMonth = currentMonth.toISOString().slice(0, 7);
            window.location.href = `course_page.php?course_id=<?php echo $course_id; ?>&section_number=<?php echo $section_number; ?>&month=${newMonth}`;
        }
        ...
        // to close the zoomed excuse pic
        function closeModal() {
            const modal = document.getElementById("myModal");
